...
function Ingles() {
  return (
    ...
    <div className="ingles-content">
      <h1>Niveles de Inglés</h1>

      
      <div className="card">
        <img src="https://source.unsplash.com/random/300x200" alt="Imagen 3" />
        <h2 className="title-card">Nivel Básico</h2>
        <p>
        Este nivel está diseñado para principiantes que apenas tienen conocimientos básicos del idioma.
      ...
      <div className="card">
        <img src="https://source.unsplash.com/random/300x200" alt="Imagen 3" />
        <h2 className="title-card">Nivel Intermedio </h2>
        <p>
          En este nivel, ampliarás tu vocabulario y mejorarás tu comprensión auditiva y expresión escrita.
      ...
      <div className="card">
        <img src="https://source.unsplash.com/random/300x200" alt="Imagen 3" />
        <h2 className="title-card">Nivel Avanzado</h2>
        <p>
        Este nivel está diseñado para aquellos que buscan una comprensión más profunda del idioma.
      ...
      <p className='frist'>
        Si deseas alcanzar un dominio superior del inglés, puedes optar por los siguientes niveles especializados.
      </p>

      <div className="card">
        <img src="https://source.unsplash.com/random/300x200" alt="Imagen 3" />
        <h2 className="title-card">Nivel Negocios</h2>
        <p>
        Este nivel se enfoca en el vocabulario y las habilidades necesarias para el ámbito laboral y empresarial.
        Aprenderás a redactar correos electrónicos formales,
      ...
      <div className="card">
        <img src="https://source.unsplash.com/random/300x200" alt="Imagen 3" />
        <h2 className="title-card">Nivel Preparación para Exámenes</h2>
        <p>
        Este nivel está diseñado específicamente para aquellos que desean prepararse
         para exámenes estandarizados de inglés, como TOEFL, IELTS o Cambridge.
      ...
      <div className="card">
        <img src="https://source.unsplash.com/random/300x200" alt="Imagen 3" />
        <h2 className="title-card">Nivel Académico</h2>
        <p>
        Si planeas estudiar en una universidad de habla inglesa o realizar investigaciones académicas,
         este nivel te preparará para comprender textos académicos,
      ...
      <p className="frist">
        ...
        Enriquecimiento cultural: Aprender inglés te permite explorar y comprender mejor la cultura, la literatura, el cine y la música de los países de habla inglesa. Además, te brinda la oportunidad de conectarte con personas de diferentes orígenes y perspectivas, lo que fomenta la apertura mental y el entendimiento intercultural.
      </p>
